            ...
            <div class="col-lg-10">
                <div class="card bg-light mb-3" style="width:100%;">
                    ...
                    <div class="card-body" style="text-align:center;">
                        <br/>
                        <h4 class="card-title">Wystąpił błąd podczas realizacji przelewu. Sprawdź ponownie stan swojego konta lub wprowadzone dane.</h4>
                        <br/>
                        <a href="przelew.php" class="btn btn-default btn-dark" role="button" style="width:20%">Powrót</a>
                    </div>
