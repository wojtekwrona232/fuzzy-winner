...
class CreateAccountsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $firstClient = app('App\Http\Controllers\AccountController')->calculateAccountNumber('0012547896325416');
        $secondClient = app('App\Http\Controllers\AccountController')->calculateAccountNumber('9874587536985201');
